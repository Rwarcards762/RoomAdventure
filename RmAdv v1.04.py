###########################################################################################
# Name: BETA TEST 1 (v1.04)
# Date: 3/23/18 11:05PM
# Description: BETA TEST ROOM ADVENTURE GUI
###########################################################################################
from Tkinter import *
...
class Game(Frame):
        ...
        def createRooms(self):
                ...
                r5 = Room("Upstairs: Room 5", "room1.gif") # room 1 is a placeholder image
                r6 = Room("Upstairs: Room 6", "room1.gif")
                r7 = Room("Upstairs: Room 7", "room1.gif")
                r8 = Room("Roof", "room1.gif")
                r9 = Room("Top of the Roof", "room1.gif")
                r10 = Room("Attic", "room1.gif")
                r0 = Room("the road. You escaped!", "room1.gif")
